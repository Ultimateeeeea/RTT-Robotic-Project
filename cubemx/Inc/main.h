...
#define Front_ECHO_EXTI_IRQn EXTI4_IRQn
#define Right_ECHO_Pin GPIO_PIN_5
#define Right_ECHO_GPIO_Port GPIOG
#define Right_ECHO_EXTI_IRQn EXTI9_5_IRQn
#define Back_ECHO_Pin GPIO_PIN_6
#define Back_ECHO_GPIO_Port GPIOG
#define Back_ECHO_EXTI_IRQn EXTI9_5_IRQn
#define Left_ECHO_Pin GPIO_PIN_7
#define Left_ECHO_GPIO_Port GPIOG
#define Left_ECHO_EXTI_IRQn EXTI9_5_IRQn

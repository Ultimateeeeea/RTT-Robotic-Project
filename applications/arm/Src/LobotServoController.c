...
//
//volatile rt_device_t arm_uart = RT_NULL;
//
//
//
...
//
///* 打开步进电机串口uart3 */
//rt_err_t arm_uart_init(const char *uart_name)
//{
//    arm_uart = rt_device_find(uart_name);
//
//    if (arm_uart)
//    {
...
//    }
//
//    if (!arm_uart) return -RT_ERROR;    //找不到返回-1
//    return rt_device_open(arm_uart, RT_DEVICE_FLAG_RDWR | RT_DEVICE_FLAG_DMA_RX);   //开启读写与DMA的收
//}
//
//int uart3_init(void)
//{
//
//    arm_uart_init(UART_DEV_NAME);
//    return 0;
//}
//
...
//
///**/
//static void uartWriteBuf(const uint8_t *buf, uint8_t len)
//{
//
//    // 检查 motor_uart 是否有效
//    if (arm_uart == RT_NULL)
//    {
//        rt_kprintf("arm_uart device is NULL! can't send!\n");
//        return;
//    }
//
//    rt_device_write(arm_uart, 0, buf, len);
